...
- [Liquid emerald background](liquid-background.md) — fixed z-index:-1 canvas backdrop; cheap via small render+CSS blur; body/.auth-screen must stay transparent or it's hidden.
